        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <a class="nav-link" href="kontrak_mk.php">Kontrak Mata Kuliah</a>
            </div>
          </div>
        </div>
      </nav>
          ...
          if ( !empty($result)) { 
            foreach ($result as $data) : ?> 
              ...
              <tr> 
                ...
                <td> 
                   <a name="edit" id="edit"  class="btn btn-success" href="edit_kontrakmk.php?id=<?= $data->id ?>">Edit</a> 
                 ...
                 <tr> 
                <td colspan="8">Belum ada data pada tabel Kontrak Mata Kuliah.</td> 
              </tr> 
